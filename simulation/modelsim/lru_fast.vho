...
-- b2	=>  Location: PIN_G26,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- Equation(s):
-- \WideOr0~0_combout\ = (\used_counter~42_combout\) # ((\used_counter~45_combout\) # ((\used_counter~43_combout\) # (\used_counter~44_combout\)))
...
PORT MAP (
	...
	datac => \used_counter~43_combout\,
	datad => \used_counter~44_combout\,
...
-- Equation(s):
-- \WideOr0~1_combout\ = (\used_counter~48_combout\) # ((\used_counter~49_combout\) # ((\used_counter~46_combout\) # (\used_counter~47_combout\)))
...
PORT MAP (
	...
	datad => \used_counter~47_combout\,
	combout => \WideOr0~1_combout\);

-- Location: LCCOMB_X44_Y18_N6
\WideOr0~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \WideOr0~2_combout\ = (\used_counter~41_combout\) # ((\WideOr0~1_combout\) # ((\used_counter~40_combout\) # (\WideOr0~0_combout\)))
...
-- Equation(s):
-- \used_counter~61_combout\ = (\pressedIndex~2_combout\ & ((\b3~combout\ & ((\Add0~16_combout\))) # (!\b3~combout\ & (\used_counter[2][8]~regout\)))) # (!\pressedIndex~2_combout\ & (((\used_counter[2][8]~regout\))))
...
-- Equation(s):
-- \WideOr3~1_combout\ = (\used_counter~77_combout\) # ((\used_counter~75_combout\) # ((\used_counter~78_combout\) # (\used_counter~76_combout\)))
...
PORT MAP (
	...
	datac => \used_counter~78_combout\,
	datad => \used_counter~76_combout\,
...
-- Equation(s):
-- \WideOr2~1_combout\ = (\used_counter~65_combout\) # ((\used_counter~66_combout\) # ((\used_counter~64_combout\) # (\used_counter~67_combout\)))
...
-- Equation(s):
-- \WideOr1~0_combout\ = (\used_counter~50_combout\) # ((\used_counter~52_combout\) # ((\used_counter~51_combout\) # (\used_counter~53_combout\)))
...
-- Equation(s):
-- \WideOr4~1_combout\ = (\used_counter~87_combout\) # ((\used_counter~88_combout\) # ((\used_counter~89_combout\) # (\used_counter~90_combout\)))
...
-- Equation(s):
-- \timer~4_combout\ = (\Add0~16_combout\ & !\rst~combout\)
...
-- Equation(s):
-- \used_counter~108_combout\ = (!\rst~combout\ & \used_counter~53_combout\)
...
-- Equation(s):
-- \used_counter~140_combout\ = (!\rst~combout\ & \used_counter~69_combout\)
...
-- Equation(s):
-- \t|counter~3_combout\ = (\t|Add0~6_combout\ & (\t|Equal0~10_combout\ & !\rst~combout\))
...
-- Equation(s):
-- \t|counter~5_combout\ = (\t|Equal0~10_combout\ & (\t|Add0~12_combout\ & !\rst~combout\))
...
-- Equation(s):
-- \t|counter~7_combout\ = (\t|Equal0~10_combout\ & (\t|Add0~8_combout\ & !\rst~combout\))
...
-- Equation(s):
-- \t|counter~15_combout\ = (\t|Add0~30_combout\ & (!\rst~combout\ & \t|Equal0~10_combout\))
...
-- Equation(s):
-- \t|counter~27_combout\ = (\t|Add0~54_combout\ & (!\rst~combout\ & \t|Equal0~10_combout\))
...
-- Equation(s):
-- \t|counter~30_combout\ = (\t|Add0~60_combout\ & (!\rst~combout\ & \t|Equal0~10_combout\))
...
-- Equation(s):
-- \t|counter~6_combout\ = (\t|Equal0~10_combout\ & (\t|Add0~10_combout\ & !\rst~combout\))
...
-- Equation(s):
-- \t|counter~4_combout\ = (\t|Equal0~10_combout\ & (\t|Add0~14_combout\ & !\rst~combout\))
...
-- Equation(s):
-- \t|counter~8_combout\ = (\t|Equal0~10_combout\ & (\t|Add0~16_combout\ & !\rst~combout\))
...
-- Equation(s):
-- \t|counter~10_combout\ = (\t|Add0~20_combout\ & (\t|Equal0~10_combout\ & !\rst~combout\))
...
-- Equation(s):
-- \t|Equal0~2_combout\ = (\t|Add0~22_combout\) # ((\t|Add0~20_combout\) # ((\t|Add0~16_combout\) # (\t|Add0~18_combout\)))
...
-- Equation(s):
-- \t|counter~31_combout\ = (\t|Add0~62_combout\ & (!\rst~combout\ & \t|Equal0~10_combout\))
...
-- Equation(s):
-- \t|counter~25_combout\ = (\t|Add0~52_combout\ & (!\rst~combout\ & \t|Equal0~10_combout\))
...
-- Equation(s):
-- \t|counter~16_combout\ = (\t|Add0~32_combout\ & (\t|Equal0~10_combout\ & !\rst~combout\))
...
-- Equation(s):
-- \t|counter~17_combout\ = (\t|Add0~36_combout\ & (!\rst~combout\ & \t|Equal0~10_combout\))
...
-- Equation(s):
-- \t|counter~26_combout\ = (\t|Add0~50_combout\ & (!\rst~combout\ & \t|Equal0~10_combout\))
...
-- Equation(s):
-- \t|counter~28_combout\ = (\t|Add0~56_combout\ & (!\rst~combout\ & \t|Equal0~10_combout\))
...
PORT MAP (
	dataa => \index~2_combout\,
	datab => \used_counter~104_combout\,
	datac => \index~1_combout\,
	datad => \used_counter~91_combout\,
...
-- Equation(s):
-- \used_counter~106_combout\ = (!\rst~combout\ & \used_counter~52_combout\)
...
-- Equation(s):
-- \used_counter~107_combout\ = (\used_counter~106_combout\ & (((!\used_counter~91_combout\) # (!\index~1_combout\)) # (!\index~2_combout\)))
...
PORT MAP (
	dataa => \index~1_combout\,
	datab => \used_counter~170_combout\,
	datac => \index~2_combout\,
	datad => \used_counter~91_combout\,
...
-- Equation(s):
-- \used_counter~56_combout\ = (\b2~combout\ & ((\b1~combout\ & (\used_counter[1][3]~regout\)) # (!\b1~combout\ & ((\Add0~6_combout\))))) # (!\b2~combout\ & (((\used_counter[1][3]~regout\))))
...
-- Equation(s):
-- \LessThan0~7_cout\ = CARRY((\used_counter~48_combout\ & (\used_counter~56_combout\ & !\LessThan0~5_cout\)) # (!\used_counter~48_combout\ & ((\used_counter~56_combout\) # (!\LessThan0~5_cout\))))
...
-- Equation(s):
-- \LessThan0~11_cout\ = CARRY((\used_counter~54_combout\ & ((!\LessThan0~9_cout\) # (!\used_counter~47_combout\))) # (!\used_counter~54_combout\ & (!\used_counter~47_combout\ & !\LessThan0~9_cout\)))
...
-- Equation(s):
-- \LessThan0~15_cout\ = CARRY((\used_counter~44_combout\ & (\used_counter~52_combout\ & !\LessThan0~13_cout\)) # (!\used_counter~44_combout\ & ((\used_counter~52_combout\) # (!\LessThan0~13_cout\))))
...
-- Equation(s):
-- \pressedIndex~3_combout\ = (\b3~combout\) # ((\b4~combout\) # ((!\b5~combout\ & pressedIndex(1))))
...
-- Equation(s):
-- \pressedIndex~4_combout\ = (\b2~combout\) # ((!\b5~combout\ & (!\b3~combout\ & pressedIndex(0))))
...
-- Equation(s):
-- \used_counter~128_combout\ = (\used_counter~63_combout\ & !\rst~combout\)
...
PORT MAP (
	dataa => \index~2_combout\,
	datab => \used_counter~128_combout\,
	datac => \index~1_combout\,
	datad => \used_counter~91_combout\,
...
-- Equation(s):
-- \used_counter~113_combout\ = (\used_counter~112_combout\ & (((!\used_counter~91_combout\) # (!\index~1_combout\)) # (!\index~2_combout\)))
...
-- Equation(s):
-- \index_value~39_combout\ = (\LessThan0~18_combout\ & ((\always0~0_combout\ & (\used_counter[1][0]~regout\)) # (!\always0~0_combout\ & ((\used_counter[0][0]~regout\))))) # (!\LessThan0~18_combout\ & (((\used_counter[0][0]~regout\))))
...
-- Equation(s):
-- \LessThan2~9_cout\ = CARRY((\used_counter~76_combout\ & (\index_value~32_combout\ & !\LessThan2~7_cout\)) # (!\used_counter~76_combout\ & ((\index_value~32_combout\) # (!\LessThan2~7_cout\))))
...
-- Equation(s):
-- \WideOr1~1_combout\ = (\used_counter~55_combout\) # ((\used_counter~56_combout\) # ((\used_counter~57_combout\) # (\used_counter~54_combout\)))
...
-- Equation(s):
-- \WideOr1~2_combout\ = (\WideOr1~0_combout\) # ((\used_counter~58_combout\) # ((\used_counter~59_combout\) # (\WideOr1~1_combout\)))
...
-- Equation(s):
-- \WideOr2~0_combout\ = (\used_counter~61_combout\) # ((\used_counter~60_combout\) # ((\used_counter~62_combout\) # (\used_counter~63_combout\)))
...
-- Equation(s):
-- \WideOr2~combout\ = (\WideOr2~1_combout\) # ((\used_counter~69_combout\) # ((\WideOr2~0_combout\) # (\used_counter~68_combout\)))
...
-- Equation(s):
-- \pressedIndex~0_combout\ = (!\b4~combout\ & (!\b1~combout\ & (!\b3~combout\ & !\b2~combout\)))
...
-- Equation(s):
-- \always0~2_combout\ = ((\pressedIndex~1_combout\) # ((!\pressedIndex~3_combout\) # (!\pressedIndex~5_combout\))) # (!\pressedIndex~2_combout\)
...
PORT MAP (
	dataa => \index~2_combout\,
	datab => \used_counter~176_combout\,
	datac => \index~1_combout\,
	datad => \used_counter~91_combout\,
...
-- Equation(s):
-- \index_value~50_combout\ = (\LessThan2~18_combout\ & (((\index_value~49_combout\)))) # (!\LessThan2~18_combout\ & ((\index_value~21_combout\ & (\Add0~12_combout\)) # (!\index_value~21_combout\ & ((\index_value~49_combout\)))))
...
-- Equation(s):
-- \used_counter~151_combout\ = (\used_counter~182_combout\ & ((\index~2_combout\) # ((!\index~1_combout\) # (!\used_counter~91_combout\))))
...
-- Equation(s):
-- \LessThan3~15_cout\ = CARRY((\used_counter~85_combout\ & ((!\LessThan3~13_cout\) # (!\index_value~48_combout\))) # (!\used_counter~85_combout\ & (!\index_value~48_combout\ & !\LessThan3~13_cout\)))
...
-- Equation(s):
-- \LessThan3~17_cout\ = CARRY((\used_counter~84_combout\ & (\index_value~46_combout\ & !\LessThan3~15_cout\)) # (!\used_counter~84_combout\ & ((\index_value~46_combout\) # (!\LessThan3~15_cout\))))
...
-- Equation(s):
-- \WideOr4~0_combout\ = (\used_counter~86_combout\) # ((\used_counter~84_combout\) # ((\used_counter~83_combout\) # (\used_counter~85_combout\)))
...
-- Equation(s):
-- \WideOr4~2_combout\ = (\WideOr4~1_combout\) # ((\used_counter~81_combout\) # ((\WideOr4~0_combout\) # (\used_counter~82_combout\)))
...
-- Equation(s):
-- \always0~4_combout\ = (\always0~3_combout\ & (\WideOr1~2_combout\ & (\WideOr2~combout\ & \WideOr4~2_combout\)))
...
-- Equation(s):
-- \index_value~15_combout\ = (\b1~combout\ & ((\LessThan0~18_combout\ & ((\index_value~14_combout\))) # (!\LessThan0~18_combout\ & (\Add0~4_combout\)))) # (!\b1~combout\ & (((\index_value~14_combout\))))
...
-- Equation(s):
-- \index_value~18_combout\ = (\LessThan0~18_combout\ & ((\always0~0_combout\ & (\used_counter[1][0]~regout\)) # (!\always0~0_combout\ & ((\used_counter[0][0]~regout\))))) # (!\LessThan0~18_combout\ & (((\used_counter[0][0]~regout\))))
...
-- Equation(s):
-- \LessThan1~9_cout\ = CARRY((\index_value~11_combout\ & ((!\LessThan1~7_cout\) # (!\used_counter~65_combout\))) # (!\index_value~11_combout\ & (!\used_counter~65_combout\ & !\LessThan1~7_cout\)))
...
PORT MAP (
	...
	datab => \index~2_combout\,
	datac => \used_counter~91_combout\,
	datad => \used_counter~181_combout\,
...
-- Equation(s):
-- \WideOr3~2_combout\ = (\WideOr3~1_combout\) # ((\WideOr3~0_combout\) # ((\used_counter~80_combout\) # (\used_counter~79_combout\)))
